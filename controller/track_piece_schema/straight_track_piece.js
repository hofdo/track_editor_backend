/**
 * This function configures the configuration and coordinates of the straight track piece
 * @param start_x: The start value for the coordinate's
 * @param outer_distance: Outer distance from the lane to the end of the canvas
 * @param side_line_start: The start coordinate for the sidelines
