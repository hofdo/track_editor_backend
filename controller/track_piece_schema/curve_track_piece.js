/**
 * his function configures the configuration and coordinates of the curve track piece
 * @param start: The start of the arc of the curve
 * @param end: The end of the arc of the curve
 * @param outer_distance: Outer distance from the arc to the end of the canvas:
 * @param outer_distance_sideline: Outer distance from the sidelines to the end of the canvas:
 * @param start_code: Start coordinates of the track id and location id codes
 * @param code_length_rad: Length of the code segment in radian
 * @param start_length_rad: Length of the start segment in radian
 * @returns List: Returns the list of the coordinates
 */
